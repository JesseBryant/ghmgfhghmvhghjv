//
//  Ferg meal prep ViewController.swift
//  ghmgfhghmvhghjv
//
...
import UIKit
import AVKit
class Ferg_meal_prep_ViewController: UIViewController {
    ...
    func playVid(){
        if let firstPath = Bundle.main.path(forResource: "fergPrepingFood", ofType: ".mp4"){
